  ...
  <div class="dine-in-order-list">
    ...
    <el-card shadow="never">
      <el-table :data="tableData" v-loading="loading" stripe border style="width: 100%">
        ...
        <el-table-column prop="payment_method" label="支付方式" width="130" />
...
import { getDineInOrderList, getDineInOrderDetail, getStoreOptions } from '../../api/data'
...
async function fetchData() {
  ...
  try {
    ...
    const res = await getDineInOrderList(params)
...
async function openDetail(row) {
  ...
  try {
    const res = await getDineInOrderDetail(row.order_no)
