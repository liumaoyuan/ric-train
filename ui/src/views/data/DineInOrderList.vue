  ...
  <div class="dine-in-order-list">
    ...
    <el-card shadow="never">
      <el-table :data="tableData" v-loading="loading" stripe border style="width: 100%">
        ...
        <el-table-column prop="payment_method_or_platform" label="支付方式" width="130" />
    ...
    <el-dialog v-model="detailVisible" title="订单详情" width="800px" :close-on-click-modal="false">
      <template v-if="detail">
        <el-descriptions :column="2" border>
          ...
          <el-descriptions-item label="订单类型">堂食</el-descriptions-item>
          <el-descriptions-item label="支付方式">{{ detail.payment_method_or_platform }}</el-descriptions-item>
...
const query = reactive({ page: 1, page_size: 10, store_id: '', order_type: 'dine_in', date_from: '', date_to: '' })
